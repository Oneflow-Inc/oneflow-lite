...
OFLITE_API const OfLiteAttrDef* OfLiteOpDefQueryAttr(const OfLiteOpDef* def, int index) {
  ...
  return reinterpret_cast<const OfLiteAttrDef*>(oneflow_lite_AttrDef_vec_at(flatc_attrs, index));
}
...
OFLITE_API const OfLiteAttrDef* OfLiteOpDefQueryAttrByName(const OfLiteOpDef* def, OfLiteStringRef name) {
  ...
  for (int i = 0; i < oneflow_lite_AttrDef_vec_len(flatc_attrs); ++i) {
    oneflow_lite_AttrDef_table_t flatc_attr = oneflow_lite_AttrDef_vec_at(flatc_attrs, i);
    flatbuffers_string_t flatc_attr_key = oneflow_lite_AttrDef_key(flatc_attr);
    if (OfLiteStringRefEqual(name, OfLiteStringRef{flatc_attr_key, flatbuffers_string_len(flatc_attr_key)})) {
...
OFLITE_API OfLiteStringRef OfLiteAttrDefQueryName(const OfLiteAttrDef* def) {
  flatbuffers_string_t name = oneflow_lite_AttrDef_key(reinterpret_cast<const oneflow_lite_AttrDef_table_t>(def));
...
OFLITE_API OfLiteStringRef OfLiteAttrDefQueryType(const OfLiteAttrDef* def) {
  flatbuffers_string_t type = oneflow_lite_AttrDef_type(reinterpret_cast<const oneflow_lite_AttrDef_table_t>(def));
...
OFLITE_API int32_t OfLiteAttrDefQueryValue_AsI32(const OfLiteAttrDef* def) {
  flatbuffers_int8_vec_t value = oneflow_lite_AttrDef_value(reinterpret_cast<const oneflow_lite_AttrDef_table_t>(def));
  if (flatcc_verify_ok != oneflow_lite_I32Def_verify_as_root(value, flatbuffers_int8_vec_len(value))) {
    OFLITE_FAIL("failed to verify buffer as I32Def root\n");
  }
  return oneflow_lite_I32Def_value(oneflow_lite_I32Def_as_root(value));
}

OFLITE_API int32_t OfLiteOpDefQueryAttrValue_AsI32(const OfLiteOpDef* def, int index) {
  return OfLiteAttrDefQueryValue_AsI32(OfLiteOpDefQueryAttr(def, index));
}

OFLITE_API int32_t OfLiteOpDefQueryAttrValueByName_AsI32(const OfLiteOpDef* def, OfLiteStringRef name) {
...
OFLITE_API int64_t OfLiteAttrDefQueryValue_AsI64(const OfLiteAttrDef* def) {
  flatbuffers_int8_vec_t value = oneflow_lite_AttrDef_value(reinterpret_cast<const oneflow_lite_AttrDef_table_t>(def));
  if (flatcc_verify_ok != oneflow_lite_I64Def_verify_as_root(value, flatbuffers_int8_vec_len(value))) {
    OFLITE_FAIL("failed to verify buffer as I64Def root\n");
  }
  return oneflow_lite_I64Def_value(oneflow_lite_I64Def_as_root(value));
}

OFLITE_API int64_t OfLiteOpDefQueryAttrValue_AsI64(const OfLiteOpDef* def, int index) {
  return OfLiteAttrDefQueryValue_AsI64(OfLiteOpDefQueryAttr(def, index));
}

OFLITE_API int64_t OfLiteOpDefQueryAttrValueByName_AsI64(const OfLiteOpDef* def, OfLiteStringRef name) {
...
OFLITE_API float OfLiteAttrDefQueryValue_AsF32(const OfLiteAttrDef* def) {
  flatbuffers_int8_vec_t value = oneflow_lite_AttrDef_value(reinterpret_cast<const oneflow_lite_AttrDef_table_t>(def));
  if (flatcc_verify_ok != oneflow_lite_F32Def_verify_as_root(value, flatbuffers_int8_vec_len(value))) {
    OFLITE_FAIL("failed to verify buffer as F32Def root\n");
  }
  return oneflow_lite_F32Def_value(oneflow_lite_F32Def_as_root(value));
}

OFLITE_API float OfLiteOpDefQueryAttrValue_AsF32(const OfLiteOpDef* def, int index) {
  return OfLiteAttrDefQueryValue_AsF32(OfLiteOpDefQueryAttr(def, index));
}

OFLITE_API float OfLiteOpDefQueryAttrValueByName_AsF32(const OfLiteOpDef* def, OfLiteStringRef name) {
...
OFLITE_API double OfLiteAttrDefQueryValue_AsF64(const OfLiteAttrDef* def) {
  flatbuffers_int8_vec_t value = oneflow_lite_AttrDef_value(reinterpret_cast<const oneflow_lite_AttrDef_table_t>(def));
  if (flatcc_verify_ok != oneflow_lite_F64Def_verify_as_root(value, flatbuffers_int8_vec_len(value))) {
    OFLITE_FAIL("failed to verify buffer as F64Def root\n");
  }
  return oneflow_lite_F64Def_value(oneflow_lite_F64Def_as_root(value));
}

OFLITE_API double OfLiteOpDefQueryAttrValue_AsF64(const OfLiteOpDef* def, int index) {
  return OfLiteAttrDefQueryValue_AsF64(OfLiteOpDefQueryAttr(def, index));
}

OFLITE_API double OfLiteOpDefQueryAttrValueByName_AsF64(const OfLiteOpDef* def, OfLiteStringRef name) {
  return OfLiteAttrDefQueryValue_AsF64(OfLiteOpDefQueryAttrByName(def, name));
}

OFLITE_API OfLiteStringRef OfLiteAttrDefQueryValue_AsString(const OfLiteAttrDef* def) {
  flatbuffers_int8_vec_t value = oneflow_lite_AttrDef_value(reinterpret_cast<const oneflow_lite_AttrDef_table_t>(def));
  if (flatcc_verify_ok != oneflow_lite_StringDef_verify_as_root(value, flatbuffers_int8_vec_len(value))) {
    OFLITE_FAIL("failed to verify buffer as StringDef root\n");
  }
  flatbuffers_string_t s = oneflow_lite_StringDef_value(oneflow_lite_StringDef_as_root(value));
  return OfLiteStringRef{s, flatbuffers_string_len(s)};
}

OFLITE_API OfLiteStringRef OfLiteOpDefQueryAttrValue_AsString(const OfLiteOpDef* def, int index) {
  return OfLiteAttrDefQueryValue_AsString(OfLiteOpDefQueryAttr(def, index));
}

OFLITE_API OfLiteStringRef OfLiteOpDefQueryAttrValueByName_AsString(const OfLiteOpDef* def, OfLiteStringRef name) {
  return OfLiteAttrDefQueryValue_AsString(OfLiteOpDefQueryAttrByName(def, name));
}
