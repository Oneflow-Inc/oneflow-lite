...
*/
#ifndef ONEFLOW_LITE_CORE_EVENT_H_
#define ONEFLOW_LITE_CORE_EVENT_H_
...
typedef struct OfLiteEventVTable {
  void (*destory)(OfLiteEvent* event);
} OfLiteEventVTable;
...
#endif  // ONEFLOW_LITE_CORE_EVENT_H_
